...
$string['providerdesc'] = 'Select if you are using Azure of YeScale';
$string['azureapiendpoint'] = 'Azure API Endpoint';
$string['azureapiendpointdesc'] = 'Enter the Azure API endpoint URL here';
$string['openaikey'] = 'YeScale or Azure API key';
$string['openaikeydesc'] = 'You can get an YeScale API key from <a href="yescale.io">YeScale</a><br>
Select the "+ Create New Secret Key" button and copy the key to this field.<br>
Note that you need to have an YeScale account that includes billing settings to get an API key.';
$string['model'] = 'Model';
